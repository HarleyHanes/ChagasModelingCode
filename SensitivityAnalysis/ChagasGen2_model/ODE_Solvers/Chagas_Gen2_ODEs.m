...
dydt=NaN(length(y),1);
     ...
     dydt(7)=gamma.DV*I_DV-(alpha.DS_DV*(I_DS/N.DS)+alpha.DR_DV*(I_DR/N.DR)+alpha.DD_DV*(I_DD/N.DD))*S_DV+lambda.SV_DV*S_SV-lambda.DV_SV*S_DV;
     dydt(8)=-gamma.DV*I_DV+(alpha.DS_DV*(I_DS/N.DS)+alpha.DR_DV*(I_DR/N.DR)+alpha.DD_DV*(I_DD/N.DD))*S_DV+lambda.SV_DV*I_SV-lambda.DV_SV*I_DV;
