...
%
dydt=NaN(length(y),1);
     dydt(1)=sigma.SV-(alpha.SS_SV*p_SS+alpha.SR_SV*p_SR)*S_SV+lambda.DV_SV*S_DV-lambda.SV_DV*S_SV-gamma.SV*S_SV;
     dydt(2)=(alpha.SS_SV*p_SS+alpha.SR_SV*p_SR)*S_SV+lambda.DV_SV*I_DV-lambda.SV_DV*I_SV-gamma.SV*I_SV;
     ...
     dydt(7)=sigma.DV-(alpha.DS_DV*p_DS+alpha.DR_DV*p_DR+alpha.DD_DV*p_DD)*S_DV+lambda.SV_DV*S_SV-lambda.DV_SV*S_DV-gamma.DV*S_DV;
     dydt(8)=(alpha.DS_DV*p_DS+alpha.DR_DV*p_DR+alpha.DD_DV*p_DD)*S_DV+lambda.SV_DV*I_SV-lambda.DV_SV*I_DV-gamma.DV*I_DV;
